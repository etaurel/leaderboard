                ...
                cells: [
                  ...
                  DataCell(
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            (jugador.hoyos_terminados == 0 || jugador.state_play == '0') ? '' : UserFunctions.scoreLBNeto(jugador.neto, jugador.status_med),
                            style: TextStyle(
                                fontFamily: 'DIN Condensed',
                                fontSize: 25,
                                color: Colors.white),
                  ...
                  DataCell(
                    Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text(
                            (jugador.hoyos_terminados == 0 || jugador.state_play == '0') ? '' : UserFunctions.scoreLBSta(jugador.stableford, jugador.status_sta),
                            style: TextStyle(
                                fontFamily: 'DIN Condensed',
                                fontSize: 25,
                                color: Colors.white),
                  ...
                  DataCell(
                    Row(
                      ...
                      children: <Widget>[
                        Text(
                          (jugador.hoyos_terminados == 0 || jugador.state_play == '0') ? '' : UserFunctions.scoreLBHoyo(jugador.hoyos_terminados, jugador.state_play),
                          // UserFunctions.scoreLBHoyo(jugador.hoyos_terminados, jugador.state_play),
                          style: TextStyle(
                              fontFamily: 'DIN Condensed',
                              fontSize: 20,
                              color: Colors.black,
