...
import 'package:golfguidescorecard/jugadores/stats.dart';
import 'package:golfguidescorecard/jugadores/stats_golpes.dart';
...
class _UsuariosState extends State<Usuarios> {
  ...
  void initState() {
    ...
    if (Platform.isAndroid) {
      adUnitId = 'ca-app-pub-3940256099942544/1033173712'; // Android ID
    } else if (Platform.isIOS) {
      adUnitId = 'ca-app-pub-2039631500993003/9751545511'; // iOS ID
    }
    interstitialAd = AdmobInterstitial(adUnitId: adUnitId,
  ...
  Widget build(BuildContext context) {
    ...
    //   // Actualizar el estado del widget con el nuevo valor de texto
    //   setState(() {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              RaisedButton(
                                ...
                                color: Colors.white,
                                child: Container(
                                  child: Image.asset('assets/ico_jugadorN.png'),
                                ),
                                onPressed: () {
                                  Navigator.push(
                                    context,
                            ...
                            Container(
                              ...
                              RaisedButton(
                                ...
                                child: Container(
                                  child: Image.asset('assets/ico_misTorneosN.png'),
                                ),
                                onPressed: () {
                          ...
                          RaisedButton(
                            ...
                            child: Container(
                              ...
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: <Widget>[
                                  Image.asset('assets/ico_jugarN.png', scale: 0.5),
                                ],
                              ),
                            ),
                            onPressed: () async { /// GOOGLE ADMOB
                              ...
                              RaisedButton(
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    mainAxisAlignment: MainAxisAlignment.center,
                                    children: <Widget>[
                                      Image.asset('assets/ico_practicaB.png', scale: 2, fit: BoxFit.contain),
                                    ],
                                  ),
                                ),
                                onPressed: () async { /// GOOGLE ADMOB
...
//                color: Color(0xFF1f2f50),
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: <Widget>[
                                Image.asset('assets/ico_tarjetaB.png', scale: 1),
                              ],
                            ),
                          ),
                          onPressed: () {
...
//                        color: Color(0xFFFF0030),
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: <Widget>[
                                Image.asset('assets/ico_leaderboardB.png', scale: 1),
                              ],
                            ),
                          ),
                          onPressed: () {
    ...
    return RaisedButton(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: <Widget>[
            Image.asset('assets/ico_misTorneosN.png', scale: 1),
          ],
        ),
      ),
      onPressed: () async { /// GOOGLE ADMOB
...
/// AlertDialogTorneosEnJuego
  AlertDialogTorneosEnJuego(BuildContext context) async {
    ...
    // await Torneo.getTorneosFecha(Fecha.fechaHoy);
...
//    print(controllerCodigoTorneo.text);
  ...
  void _buscarTorneosDelUsuario() async {
